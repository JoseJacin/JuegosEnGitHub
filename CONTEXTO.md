...
- T1, T2 y T3 están integradas en `main`. La corrección actual de T3 genera varias capas y mezcla colores en botellas donantes mediante una secuencia inversa de trasvases válidos; cada color conserva una botella objetivo y todas empiezan parcialmente llenas. La rama `feature/010_t3_capas_mezcladas` contiene esta revisión pendiente de integrar. El juego aún no implementa trasvases interactivos (T4).
